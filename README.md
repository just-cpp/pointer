...
<br>
* 모든 디렉토리의 예제들이 위의 세 개의 파일들로 구성되어 있으므로 컴파일러별로 빌드와 실행 방법이 동일합니다. 아래의 내용을 참고해서 빌드하시면 됩니다.<br>
##### * Visual C++
```
...
소스 디렉토리로 이동 후 아래와 같이 gcc(또는 g++) 명령어로 빌드 및 실행
...
이때, -m64 또는 -m32 옵션을 통해 강제로 생성되는 바이너리의 bit를 설정할 수 있습니다.
